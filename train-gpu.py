...
def loadImages():
    ...
    for item in list:
        ...
        if(os.path.isfile(path)):
            f=cv2.imread(path)
            f=cv2.resize(f, (img_row, img_col))#resize到網絡input的shape
            imageList.append(f)
